...
class Mesh():
    ...
    def export_to_open3d(self):
        ...
        mesh.vertices = o3d.utility.Vector3dVector(self.vertices.detach().cpu().numpy().astype(np.float32))
        mesh.triangles = o3d.utility.Vector3iVector(self.faces.detach().cpu().numpy().astype(np.int32))
