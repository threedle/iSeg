...
pip install ftfy==6.1.1 regex==2023.10.3 tqdm==4.66.1 # install additional packages
...
python -m pip install polyscope==2.3.0 # install PolyScope for interactive demo
pip install numpy==1.26.4 # reinstall NumPy after PolyScope for compatibility with other packages
